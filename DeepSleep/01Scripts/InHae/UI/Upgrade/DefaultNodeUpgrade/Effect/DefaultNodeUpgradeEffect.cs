...
public class DefaultNodeUpgradeEffect : MonoBehaviour
{
    ...
    private DefaultUpgradeCheckPanel _defaultUpgradeCheckPanel;
    ...
    private void Awake()
    {
        _defaultUpgradeCheckPanel = GetComponent<DefaultUpgradeCheckPanel>();
        _checkButton = transform.Find("Buttons/CheckButton").gameObject;

        _defaultUpgradeCheckPanel.UpgradeEvent += UpgradeCheckTween;
