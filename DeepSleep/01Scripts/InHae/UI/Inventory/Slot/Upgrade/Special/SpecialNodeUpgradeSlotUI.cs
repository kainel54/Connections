...
public class SpecialNodeUpgradeSlotUI : ItemSlotUI, IPointerClickHandler
{
    ...
    private void Awake()
    {
        _specialNodeEventChannelSO.AddListener<UpgradeSkillSelectLockEvent>(HandleLockChange);
    }

    private void OnDestroy()
    {
        _specialNodeEventChannelSO.RemoveListener<UpgradeSkillSelectLockEvent>(HandleLockChange);
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        _specialNodeEventChannelSO.RaiseEvent(selectImageEvt);

        var evt = SpecialNodeUpgradeEvents.UpgradeSkillSelectEvent;
        evt.item = item as SkillInventoryItem;
        _specialNodeEventChannelSO.RaiseEvent(evt);
    }
